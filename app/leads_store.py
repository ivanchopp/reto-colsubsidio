        ...
        conn.execute(
            text(
                ...
                insert into leads (
                    ...
                    codigos_razones, conflictos, peer_stats,
                ...
                on conflict (session_id) do update set
                    ...
                    conflictos = excluded.conflictos,
            ...
            ),
            {
                ...
                "conflictos": _a_jsonb(conflictos),
...
_CAMPOS_JSONB = (
    "razones", "codigos_razones", "conflictos", "peer_stats", "subsidios_elegibles",
    "contribuciones", "bloqueantes", "datos_declarados",
)
